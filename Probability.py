...
# ==========================================================
# 1. Dataset Generation (Stronger correlations)
# ==========================================================
def create_high_accuracy_weather_dataset(path="weather_high_accuracy.csv", n=100_000):
    ...
    # Generate Rain with strong correlated patterns
    probs = []
    ...
    print(f"✅ Generated high-accuracy dataset → {path}")
    return df
...
def main():
    ...
    plt.tight_layout()
    plt.savefig("rain_probability_high_accuracy.png", dpi=180)
    plt.show()
    print("\nSaved visualization → rain_probability_high_accuracy.png")
    ...
    with open("naive_bayes_high_accuracy_model.json", "w", encoding="utf-8") as f:
        json.dump(model_data, f, indent=2)
    print("Model saved → naive_bayes_high_accuracy_model.json")
